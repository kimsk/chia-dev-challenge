...
winning_number = 10 # nobody wins, rewards go to farmer as fee!
...
winning_amount = 0 if len(winning_tickets) == 0 else math.floor(
...
# get block record
# and we should see 5001 paid to farmer
block_record = sim.get_block_record_by_height(block_height + 1)
print(block_record.reward_claims_incorporated)
